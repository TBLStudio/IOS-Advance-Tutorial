...
class ContactImporter: NSObject {
    ...
    func listenForChanges() {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(ContactImporter.addressBookDidChane(_:)), name: CNContactStoreDidChangeNotification, object: nil)
    }
    func addressBookDidChane(notification: NSNotification) {
        let now = NSDate()
