...
class FavoriteViewController: UIViewController , TableViewFetchedResultsDisplayer, ContextViewController {
    ...
    override func setEditing(editing: Bool, animated: Bool) {
        ...
        if editing {
            ...
            navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Delete All", style: .Plain, target: self, action: #selector(FavoriteViewController.deleteAll))
        } else {
    ...
    func configureCell(cell: UITableViewCell, atIndexPath indexPath: NSIndexPath) {
        ...
        cell.phoneTypeLabel.text =  contact.phoneNumbers?.filter({ number in
